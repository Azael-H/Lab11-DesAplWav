          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <p className="text-sm text-blue-800">
                <strong>CSS Modules usado para:</strong> Efecto de onda al click,
                animación de loading, gradientes complejos, transiciones hover
              </p>
            </div>
          </div>
        </Card>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="bg-purple-50 p-4 rounded-lg mt-4">
              <p className="text-sm text-purple-800">
                <strong>Combinación efectiva:</strong> CSS Modules para label flotante,
                animación de error y efectos de focus. Tailwind para layout, colores y responsive.
              </p>
            </div>
          </form>
        </Card>
